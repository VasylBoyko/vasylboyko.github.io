...
Skin.prototype.setSkin (const QString& path)
{
...
Skin.prototype.reloadSkin()
{
    setSkin (m_skin_dir.absolutePath ());
}

Skin.prototype.loadMain()
{
...
Skin.prototype.getPixmap (const QString& name)
{
...
Skin.prototype.getPath (const QString& name)
{
    m_skin_dir.setFilter (QDir::Files | QDir::Hidden | QDir::NoSymLinks);
    QFileInfoList f = m_skin_dir.entryInfoList();
...
Skin.prototype.loadLetters(void)
{
...
Skin.prototype.createRegion(const QString &path, const QString &key)
{
    QRegion region;
...
Skin.prototype.getDummyPixmap(const QString& name)
{
    QDir dir (":/default");
...
Skin.prototype.scalePixmap(const QPixmap &pix, int ratio)
{
