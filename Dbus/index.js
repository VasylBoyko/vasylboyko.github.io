...
var player = require('./playerControls');
...
function init() {
	sessionBus.getService('org.mpris.MediaPlayer2.vlc').getInterface(
		'/org/mpris/MediaPlayer2',
		'org.mpris.MediaPlayer2.Player', function(err, iface) {
		if (!err) {
			player.Create(iface, document.getElementById("playerControls"));
		}
	});
}
